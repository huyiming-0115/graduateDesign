...
<article class="cl pd-20">
    <form action="/product/updateProduct" method="post" enctype="multipart/form-data" class="form form-horizontal"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${product.price}" placeholder=""
                       id="price" name="price">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${product.zan}" placeholder="" id="zan"
                       name="zan">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${product.number}" placeholder=""
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${product.miaoshu}" placeholder=""
